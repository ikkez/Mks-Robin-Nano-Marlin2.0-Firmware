...
#define STRING_CONFIG_H_AUTHOR "(ikkez, FLSUN-QQ)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // FLSUN QQ+ 1.6mm aluminium heater with 4mm lattice glass
  #define DEFAULT_bedKp 101.59
  #define DEFAULT_bedKi 19.50
  #define DEFAULT_bedKd 352.89
...
#define DELTA
  ...
  #define DELTA_HEIGHT 377.5             // (mm) Get this value from G33 auto calibrate
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 18.6, -2.7 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), 0, DELTA_HEIGHT - 20 }
